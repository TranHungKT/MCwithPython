...
class MCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MCParser#many_vars.
    def visitMany_vars(self, ctx:MCParser.Many_varsContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MCParser#exptail.
    def visitExptail(self, ctx:MCParser.ExptailContext):
        return self.visitChildren(ctx)
