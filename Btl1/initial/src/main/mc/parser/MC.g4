...
vardecl : pritype var SEMI | pritype many_vars SEMI;

var : ID (LS INTLIT RS)?;
 
many_vars : var (CM var)* ;
...
exp7 : exp8 | SUB exp8 | NOT exp8 ;

exp8 : operands | operands LS exp RS ;

operands :  INTLIT | STRINGLIT | BOOLLIT | ID | FLOATLIT |  LB  exp  RB | func_call;
...
var_stmtList : (var_stmt var_stmtList | ) ;
var_stmt : vardecl | statement;
